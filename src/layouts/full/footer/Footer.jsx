...
import footer1 from '../../../assets/images/backgrounds/footer1.webp';
import footer2 from '../../../assets/images/backgrounds/footer2.webp';
...
const Footer = () => {
    ...
    // return (
    //     <footer className="w-full bg-footer h-[720px] relative overflow-hidden xl:w-full xl:bg-footer xl:h-fit xl:relative xl:overflow-hidden">
    //         <img src={footer1} alt='footer1' className='absolute top-0 z-1 h-fit' />
    //         <img src={footer2} alt='footer2' className='absolute bottom-0 z-2 h-fit' />
    ...
    //                 </div>
    //             </div>
    //             <p className='text-center text-[8px] py-1 font-segoeui italic xl:text-[13px] xl:py-[10.38px]'>Copyright © 2024 · Tôi Đi Từ Thiện · All Rights Reserved · Design by AMAI agency</p>
    //         </div>
    //     </footer>
    // )
}
