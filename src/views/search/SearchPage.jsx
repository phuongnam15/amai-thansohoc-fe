...
const reasons = [
  {
    title: "Hiểu rõ bản thân và tiềm năng cá nhân",
    content: [
      "Thần số học giúp khám phá điểm mạnh, điểm yếu, tính cách, và sở trường của mỗi người thông qua các con số liên quan đến ngày sinh và tên gọi.",
      "Biết được số chủ đạo (Life Path Number) sẽ giúp bạn hiểu rõ mục tiêu sâu xa và sứ mệnh của mình trong cuộc đời.",
    ],
  },
  {
    title: "Định hướng nghề nghiệp và cuộc sống",
    content: [
      "Dựa vào thần số học, bạn có thể tìm ra công việc hoặc lĩnh vực phù hợp với mình.",
      "Các con số chỉ ra khuynh hướng tự nhiên của bạn trong công việc và cuộc sống, giúp tránh chọn những nghề không phù hợp với năng lực và tính cách.",
    ],
  },
];
      ...
      <div className="relative z-30 h-full w-full">
        {/* <div className="">
          <img
            src={bgHeaderSearch}
            alt=""
            className="absolute xl:h-auto xl:w-full object-cover"
          />
          <div className="items-center justify-center flex ">
            <img
              src={logoSearch}
              alt=""
              className="hidden xl:block pt-[120px] z-40"
            />
          </div>
          ...
          <div className="container relative">
            <div className="text-white absolute inset-0">
              <h2 className=" xl:text-[24px] text-[16px] text-left font-prata-regular">
                Chú thích
              </h2>
              <ul className="xl:text-[16px] text-[14px] font-ibmplexsans-regular list-disc list-inside">
                <li>
                  ...
                  nhau thì cuộc đời các bạn sẽ có xáo trộncủa cả 2 ngày sinh
                  này. Bạn nên tra cứu cả hai ngày sinh để biết thêm, tuy nhiên
                  kết quả sẽ thiên về ngày sinh dương lịch!
                </li>
                <li>
                  Số chủ đạo rất quan trọng nhưng không thể hiện hết toàn bộ
                  thông tin thần số của bạn. Để xem kết quả tra cứu chính xác
                  nhất, hãy kết hợp tất cả các chỉ sốmà chúng tôi tính toán cho
                  bạn!{" "}
                </li>
                <li>
        ...
        <div className="relative z-10 pt-40 pb-14 container">
          <div className="flex gap-x-10 flex-col lg:flex-row">
            <div className="flex flex-col relative flex-[0.5] lg:items-center gap-4 -mb-44 lg:mb-0">
              <p className="absolute w-[70%] top-10 right-0 lg:w-full lg:static text-xl xl:text-[2rem] lg:leading-10 font-prata-regular text-transparent bg-gradient-to-r from-white to-primary-6 bg-clip-text z-20">
                Vì sao thần số học lại quan trọng và cần thiết?
              </p>
              <div className="w-[45%] lg:w-full flex flex-col items-center">
                <img
                  src={PythagoFooterSearch}
                  alt=""
                  className="-mb-6 lg:-mb-16 w-[276px] h-auto relative z-10"
                />
                <img src={earth} alt="" className="w-[382px] h-auto" />
              </div>
            </div>

            <div className="flex flex-col gap-3 flex-1 text-[14px] xl:text-base font-ibmplexsans-regular text-white z-20">
              {reasons.map((reason, index) => (
                <div key={index} className="flex flex-col gap-3">
                  ...
                  <ul className="list-disc list-inside">
                    {reason.content.map((content, contentIndex) => (
